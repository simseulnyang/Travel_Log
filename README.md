...
## 개요
- :mountain_bicyclist:개인 프로젝트로 진행한 Travel_Log입니다.
...
## <span id="task">5. 개발기간 및 기능기획관리</span>
 ### 개발 기간
    - 1차 : 2023-07-17 ~ 2023-07-20 (2단계)
    - 2차 : 2023-07-24 ~ 2023-07-25
...
## <span id="issues">9. 개발하며 겪은 이슈</span>
 ...
 #### 결론
  - 해당 코드는 굳이 url 및 class를 새로 작성할 필요 없이 게시글 목록을 보여주는 class에 추가하여 작성하면 된다는 사실을 알게되었습니다.
...
- 1차 목표 (2023.07.17 ~ 2023.07.20)
    - Django 강의에서 배운 내용들을 복습하며, 프로젝트의 핵심인 블로그 게시글의 CRUD 기능 구현에 익숙해진다.
    - 예전에 완성해 두었던 GitHub HTML+CSS repo를 기본으로 UI 커스터마이징하고, FBV보다는 CBV를 사용하여 개발한다.
    - ERD 작성 툴을 사용하여 데이터베이스 구조를 설계한다.

- 2차 목표 (2023.07.24 ~ 2023.07.25)
    - 블로그
        - [x] Category 기능을 추가하여 게시글을 조회, 검색 할 수 있다.
       
    - 유저
        - [x] Profile 관련 Model을 설정하고, User가 직접 이미지를 포함한 자신의 프로필을 설정할 수 있고, 해당 내용을 DB에 저장하여 관리할 수 있다.
